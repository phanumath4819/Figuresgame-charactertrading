					...
					<div class="card-body">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$books = $conn->query("SELECT b.*, u.name as uname,p.name,p.bid_end_datetime bdt, b.*
														FROM bids b 
								...
								<tr>
									...
									<td>
										<?php
										$o_id = $row['product_id']; //order id
										if ($row['o_id']=$row['user_id']){
                                            echo "<a href='payment.php?o_id=$o_id&do=payment' class 'btn btn-primary btn-xs'> Payment</a> ";}
										//echo "<a href='payment.php?o_id=$o_id&do=payment' class 'btn btn-primary btn-xs'> Payment</a> ";
										/*<button class="btn btn-primary btn-sm view_user" type="button" data-id ='<?php echo $row['user_id'] ?>'>Payment</button>*/
										?>
									</td>
								</tr>
								<?php endwhile; ?>
